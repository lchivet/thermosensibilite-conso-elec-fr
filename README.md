...
Deux volets, tous deux construits sur les mêmes données RTE éCO2mix (2018-2026) :
...
![Courbe monotone de charge](outputs/figures/12_courbe_monotone_charge.png)
...
│   ├── figures/                # Graphiques générés (01-05 : thermosensibilité, 11-15 : marché)
│   ├── key_results.json       # Chiffres clés (option A)
